  ...
  return (
    <>
      ...
      { validation.value ? <p 
        ...
        " rounded-full px-4 py-2 text-white fixed bottom-16 left-1/2 -translate-x-1/2 opacity-0 transition-bottom duration-300 ease-linear"}>{validation.value}</p> : null}
    </>
  )
}
